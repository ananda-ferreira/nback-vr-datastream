...
namespace Task
{
    ...
    /// </summary>
    public class NBackTask : ATask<string>
    {
        #region Properties
        ...
        // for datastreams
        public bool IsCorrectChar => IsCorrectCharacter();
        #endregion
        ...
        public NBackTask(string characterSet, int n, float stimulusDuration = 1f, float interStimulusDuration = 1f)
        {
            CharacterSet = characterSet.Split(" ");
            // CharacterSet = characterSet.Select(c => c.ToString()).ToArray();
            N = n;
        ...
        // public Dictionary<string, float> Dataset(){
        //     Dictionary<string, float> dataMap = new()
        //     {
        //         { "Triggered", IsInputTriggered ? 1.0f : 0.0f },
        //         { "AnswerCorrect", IsCorrect ? 1.0f : 0.0f },
        //         { "ReactionTime", ReactionTime },
        //         { "CharacterCorrect", IsCorrectChar ? 1.0f : 0.0f},
        //     };
        //     return dataMap; 
        // }
        #endregion
